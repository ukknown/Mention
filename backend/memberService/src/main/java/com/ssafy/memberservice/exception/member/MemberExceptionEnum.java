...
public enum MemberExceptionEnum {
    ...
    MEMBER_KAKAO_GENDER_EXCEPTION(HttpStatus.BAD_REQUEST, "M0005", "성별 동의를 해주셔야 합니다."),
    MEMBER_KAKAO_PROFILEIMAGE_EXCEPTION(HttpStatus.BAD_REQUEST, "M0006", "프로필 동의를 해주셔야 합니다.");
